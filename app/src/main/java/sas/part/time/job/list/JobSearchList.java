...
public class JobSearchList extends BaseAdapter {

	private ArrayList<JobData> mData;
	private LayoutInflater mInflater;
	private PartTimeUtils appConfig = PartTimeUtils.getSingleInstance();

	public JobSearchList(Context context, ArrayList<JobData> data) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if(view == null) {
			view = mInflater.inflate(R.layout.inflate_job_list, parent, false);
