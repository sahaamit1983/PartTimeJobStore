...
public class JobEditServer extends AsyncTask<Void, Void, ResultMsg> {	
	...
	public JobEditServer(Activity ac, IJobSubmit lis, String jobId,
	...
	protected ResultMsg doInBackground(Void... arg0) {
		...
		String URL = mActivity.getResources().getString(R.string.update_job_url);
